...
There are two questions about this topic.
...
* data gridded
* grid resolution
* non-detection inferred from other presences
* entire taxonomic group analyzed (DROP)
* results format - hypothesis testing (DROP)
* compiled individual (DROP)
