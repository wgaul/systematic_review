...
library(Hmisc)
library(tidyverse)
# note this is not the directory this R script lives in !!!!!
setwd("~/Documents/UCD/PhD_Project/systematic_review/") 
set.seed(42)


scopus <- read_csv("./search_results/scopus_15June2018_searchResults.csv", 
                   skip = 4)
scopus <- scopus[which(scopus$year >= 2014), ]
gbif <- read_csv("./search_results/GBIF_publications.csv")
gbif <- gbif[which(gbif$year >= 2014), ] # keep only 2014 to present
wos <- read_csv("./search_results/WebOfScience_15June2018.csv", 
                skip = 4)

## combine proquest files if not done yet, othewise read in combined results
if("ProQuest_combined.csv" %nin% list.files("./search_results/")) {
  pq_1 <- read_csv("./search_results/ProQuest_01.csv", 
                   skip = 4)
  pq_2 <- read_csv("./search_results/ProQuest_02.csv")
  pq_3 <- read_csv("./search_results/ProQuest_03.csv")
  pq_4 <- read_csv("./search_results/ProQuest_04.csv")
  pq_5 <- read_csv("./search_results/ProQuest_05.csv")
  pq_6 <- read_csv("./search_results/ProQuest_06.csv")
  pq_7 <- read_csv("./search_results/ProQuest_07.csv")
  pq_8 <- read_csv("./search_results/ProQuest_08.csv")
  pq_9 <- read_csv("./search_results/ProQuest_09.csv")
  pq_10 <- read_csv("./search_results/ProQuest_10.csv")
...
} else proquest <- read_csv("./search_results/ProQuest_combined.csv")
...
if("GoogleScholar_searchResults_merged.csv" %nin% 
  ...
  gs_1 <- read_csv("./search_results/PoP_GS_BiologicalrecordsIreland_no_BookNewreportNewspeciesNewrecord_2014_2018.csv", 
                   skip = 4)
  gs_2 <- read_csv("./search_results/PoP_GS_BiologicalrecordsUnitedkingdom_no_bookNewreportNewspeciesNewrecord.csv", 
                   skip = 4)
  gs_3 <- read_csv("./search_results/PoP_GS_CitizenscienceSpeciesIreland_no_DiseaseBookNewreportNewspeciesNewrecord_2014_2018.csv", 
                   skip = 4)
  gs_4 <- read_csv("./search_results/PoP_GS_CitizenscienceSpeciesUnitedkingdom_no_DiseaseBookNewreportNewspeciesNewrecord.csv", 
                   skip = 4)
  ...
  write_csv(all_gs, "./search_results/GoogleScholar_searchResults_merged.csv")
  
  gs <- all_gs # NOTE: then need to add years by hand to this
  rm(all_gs)
} else gs <- read_csv("./search_results/GoogleScholar_searchResults_merged.csv")
...
rm(keep_dups_df, possible_dups, drop_dups)
...
if("master_combined_search_results_syst_rev.csv" %nin% 
   list.files("~/Documents/UCD/PhD_Project/systematic_review/search_results/")){
