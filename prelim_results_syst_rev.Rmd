...
print(ggplot(data = spat_boot_df, 
...
plot(as.numeric(wg_dbl_cd$start.year[both_numeric]) ~ 
       as.numeric(er$start.year[both_numeric]), 
     xlab = "start year determined by coder two", 
     ylab = "start year determined by coder one")
