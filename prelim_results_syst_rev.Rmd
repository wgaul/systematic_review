...
```{r taxa}
classes <- wg$class_gbif_backbone

```


Taxa from ?? ?kingdoms? were investigated by studies in this review (Tab. ??).  ?? (Class ??) was the most commonly studied class (?? studies).  
