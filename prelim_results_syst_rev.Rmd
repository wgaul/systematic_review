...
# fit saturated model
dt_an_nb_full <- glm.nb(n ~ 1 + analysis_approach + data_type + 
                        analysis_approach:data_type, data = dt_an_df, 
...
dt_an_qp_independence_test <- anova(dt_an_qp_ind, dt_an_qp_full, test = "Chisq")
