...
**TODO: Generate a column indicating whether WhWhWh is the ONLY data type for ALL data.  By new definitions (13 Sep) the whwhwh data type is no longer mutually exclusive, but I do want to present results showing studies that used no data types other than that.  So need to construct that column in script.**
