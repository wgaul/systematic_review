...
We asked whether different types of biological records data are used to study different types of questions.  We fit Poisson regression models of the number of studies with each combination of data type and biological or ecological study focus, fitting both a saturated model and an independence model with only main effects.  We tested whether there was an interaction between data type and study question using a Chi-squared likelihood ratio test to compare the saturated and independence models.  We explored deviations from the independence model by examining the deviance residuals from the fitted independence model.  
...
data_type_study_question_plot <- ggplot(
  data = dt_pd_df, 
  ...
  labs(fill = "Deviance\nresiduals") 
print(data_type_study_question_plot + 
...
ggsave("Fig4.svg", methodology_plot + 
       ...
       width = 25, height = 25, units = "cm", 
       device = "svg")
ggsave("Fig5.svg", data_type_study_question_plot + 
         theme(text = element_text(size = t_size_save), 
...
ggsave("Fig4.jpg", methodology_plot + 
       ...
       width = 25, height = 25, units = "cm", 
       device = "jpg")
ggsave("Fig5.jpg", data_type_study_question_plot + 
         theme(text = element_text(size = t_size_save), 
               legend.key.height = grid::unit(1.5, "cm")) + 
         geom_text(aes(label = round(resids, digits = 1)), 
                   size = t_size_save/3), # write the values, 
