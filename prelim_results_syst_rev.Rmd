...
spat_boot_df # print table 1 (spatial extent)
...
#        width = 25, height = 25, units = "cm", 
#        device = "svg")
ggsave("Fig2.svg", response_var_plot + 
         theme(text = element_text(size = t_size_save)), 
       width = 25, height = 25, units = "cm", 
       device = "svg")
ggsave("Fig3.svg", data_type_study_question_perm_plot + 
         theme(text = element_text(size = t_size_save), 
  ...
  geom_text(aes(label = paste0(round(residual, digits = 1), "\n", sig_symb)), 
       ...
       width = 25, height = 25, units = "cm", 
       device = "svg")
ggsave("Fig4.svg", data_type_analysis_approach_plot + 
         theme(text = element_text(size = t_size_save), 
        legend.key.height = grid::unit(1.5, "cm")) + 
  geom_text(aes(label = paste0(round(residual, digits = 1), "\n", sig_symb)), 
            size = t_size_save/2), 
...
#        width = 25, height = 25, units = "cm", 
#        device = "jpg")
ggsave("Fig2.jpg", response_var_plot + 
         theme(text = element_text(size = t_size_save)), 
       width = 25, height = 25, units = "cm", 
       device = "jpg")
ggsave("Fig3.jpg", data_type_study_question_perm_plot + 
         theme(text = element_text(size = t_size_save), 
               legend.key.height = grid::unit(1.5, "cm")) + 
         geom_text(aes(label = paste0(round(residual, digits = 1), "\n", 
                                      sig_symb)), 
       ...
       width = 25, height = 25, units = "cm", 
       device = "jpg")
ggsave("Fig4.jpg", data_type_analysis_approach_plot + 
         theme(text = element_text(size = t_size_save), 
               legend.key.height = grid::unit(1.5, "cm")) + 
  geom_text(aes(label = paste0(round(residual, digits = 1), "\n", sig_symb)), 
            size = t_size_save/3), 
